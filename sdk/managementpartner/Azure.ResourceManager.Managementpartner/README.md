# Azure Managementpartner Management client library for .NET
...
Install the Azure Managementpartner management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.Managementpartner -Version 1.0.0-preview.1 
```
