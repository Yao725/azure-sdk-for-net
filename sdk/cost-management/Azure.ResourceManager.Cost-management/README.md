# Azure Cost-management Management client library for .NET
...
Install the Azure Cost-management management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.Cost_management -Version 1.0.0-preview.1 
```
