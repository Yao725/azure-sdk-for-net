...
namespace Azure.ResourceManager.Relay.Models
{
    ...
    public partial class HybridConnectionCreateOrUpdateAuthorizationRuleOperation : Operation<AuthorizationRule>
    {
        ...
        internal HybridConnectionCreateOrUpdateAuthorizationRuleOperation(Response<AuthorizationRule> response)
        {
            _operation = new OperationOrResponseInternals<AuthorizationRule>(response);
        }
