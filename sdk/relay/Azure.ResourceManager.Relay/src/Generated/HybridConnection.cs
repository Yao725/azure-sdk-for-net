...
namespace Azure.ResourceManager.Relay
{
    ...
    public partial class HybridConnection : ArmResource
    {
        ...
        internal HybridConnection(ArmResource options, HybridConnectionData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<HybridConnectionDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual HybridConnectionDeleteOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("HybridConnection.Delete");
            scope.Start();
            try
        ...
        public virtual async Task<Response<AuthorizationRule>> CreateOrUpdateAuthorizationRuleAsync(AuthorizationRule parameters, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("HybridConnection.CreateOrUpdateAuthorizationRule");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("HybridConnection.DeleteAuthorizationRule");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("HybridConnection.GetAuthorizationRule");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("HybridConnection.GetKeys");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<AccessKeys>> RegenerateKeysAsync(RegenerateAccessKeyParameters parameters, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("HybridConnection.RegenerateKeys");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<AuthorizationRule> GetAuthorizationRules(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("HybridConnection.GetAuthorizationRules");
                scope.Start();
                try
                {
