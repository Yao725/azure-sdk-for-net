...
namespace Azure.ResourceManager.Relay
{
    ...
    public partial class RelayNamespaceContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly NamespacesRestOperations _restClient;

        /// <summary> Initializes a new instance of the <see cref="RelayNamespaceContainer"/> class for mocking. </summary>
        protected RelayNamespaceContainer()
        {
        }

        /// <summary> Initializes a new instance of RelayNamespaceContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal RelayNamespaceContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual NamespaceCreateOrUpdateOperation CreateOrUpdate(string namespaceName, RelayNamespaceData parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("RelayNamespaceContainer.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("RelayNamespaceContainer.Get");
            scope.Start();
            try
            {
                if (namespaceName == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("RelayNamespaceContainer.GetIfExists");
            scope.Start();
            try
            {
                if (namespaceName == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("RelayNamespaceContainer.CheckIfExists");
            scope.Start();
            try
            {
                if (namespaceName == null)
        ...
        public virtual Pageable<RelayNamespace> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("RelayNamespaceContainer.GetAll");
                scope.Start();
                try
                {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("RelayNamespaceContainer.GetAllAsGenericResources");
            scope.Start();
            try
            {
