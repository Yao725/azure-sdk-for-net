# Azure Scheduler Management client library for .NET
...
Install the Azure Scheduler management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.Scheduler -Version 1.0.0-preview.1 
```
