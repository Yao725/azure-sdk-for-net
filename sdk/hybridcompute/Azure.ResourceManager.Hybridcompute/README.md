# Azure Hybridcompute Management client library for .NET
...
Install the Azure Hybridcompute management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.Hybridcompute -Version 1.0.0-preview.1 
```
