# Azure Logz Management client library for .NET
...
Install the Azure Logz management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.Logz -Version 1.0.0-preview.1 
```
