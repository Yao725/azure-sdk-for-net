...
{
    public partial class RequestApprovalResource : IUtf8JsonSerializable
    {
        ...
        internal static RequestApprovalResource DeserializeRequestApprovalResource(JsonElement element)
        {
            ...
            return new RequestApprovalResource(id, name, type, systemData.Value, offerId.Value, offerDisplayName.Value, publisherId.Value, Optional.ToList(plansDetails), Optional.ToNullable(isClosed), Optional.ToNullable(messageCode));
        }
    }
}
