...
namespace Azure.ResourceManager.Marketplace.Models
{
    ...
    public partial class RequestApprovalsList
    {
        ...
        {
            Value = new ChangeTrackingList<RequestApprovalResource>();
        }

        /// <summary> Initializes a new instance of RequestApprovalsList. </summary>
        /// <param name="value"></param>
        /// <param name="nextLink"> URL to get the next set of notifications list results if there are any. </param>
        internal RequestApprovalsList(IReadOnlyList<RequestApprovalResource> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<RequestApprovalResource> Value { get; }
