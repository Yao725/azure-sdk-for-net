...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SqlServerSecurityAlertPolicyCollection : ArmCollection, IEnumerable<SqlServerSecurityAlertPolicyResource>, IAsyncEnumerable<SqlServerSecurityAlertPolicyResource>
    {
        ...
        public virtual async Task<ArmOperation<SqlServerSecurityAlertPolicyResource>> CreateOrUpdateAsync(WaitUntil waitUntil, SqlServerSecurityAlertPolicyName securityAlertPolicyName, SqlServerSecurityAlertPolicyData data, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<SqlServerSecurityAlertPolicyResource> CreateOrUpdate(WaitUntil waitUntil, SqlServerSecurityAlertPolicyName securityAlertPolicyName, SqlServerSecurityAlertPolicyData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<SqlServerSecurityAlertPolicyResource>> GetAsync(SqlServerSecurityAlertPolicyName securityAlertPolicyName, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="securityAlertPolicyName"> The name of the security alert policy. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<SqlServerSecurityAlertPolicyResource> Get(SqlServerSecurityAlertPolicyName securityAlertPolicyName, CancellationToken cancellationToken = default)
        {
            using var scope = _sqlServerSecurityAlertPolicyServerSecurityAlertPoliciesClientDiagnostics.CreateScope("SqlServerSecurityAlertPolicyCollection.Get");
            scope.Start();
            try
