...
{
    public partial class SqlServerUsage : IUtf8JsonSerializable
    {
        ...
        internal static SqlServerUsage DeserializeSqlServerUsage(JsonElement element)
        {
            ...
            return new SqlServerUsage(id, name, type, systemData.Value, displayName.Value, Optional.ToNullable(currentValue), Optional.ToNullable(limit), unit.Value);
        }
    }
}
