...
namespace Azure.ResourceManager.Extendedlocation
{
    ...
    public partial class CustomLocationContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly CustomLocationsRestOperations _restClient;

        /// <summary> Initializes a new instance of the <see cref="CustomLocationContainer"/> class for mocking. </summary>
        protected CustomLocationContainer()
        {
        }

        /// <summary> Initializes a new instance of CustomLocationContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal CustomLocationContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual CustomLocationCreateOrUpdateOperation CreateOrUpdate(string resourceName, CustomLocationData parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("CustomLocationContainer.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("CustomLocationContainer.Get");
            scope.Start();
            try
            {
                if (resourceName == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("CustomLocationContainer.GetIfExists");
            scope.Start();
            try
            {
                if (resourceName == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("CustomLocationContainer.CheckIfExists");
            scope.Start();
            try
            {
                if (resourceName == null)
        ...
        public virtual Pageable<CustomLocation> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("CustomLocationContainer.GetAll");
                scope.Start();
                try
                {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("CustomLocationContainer.GetAllAsGenericResources");
            scope.Start();
            try
            {
