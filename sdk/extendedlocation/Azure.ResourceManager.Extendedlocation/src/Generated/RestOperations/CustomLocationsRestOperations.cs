...
namespace Azure.ResourceManager.Extendedlocation
{
    internal partial class CustomLocationsRestOperations
    {
        ...
        public CustomLocationsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, string subscriptionId, Uri endpoint = null, string apiVersion = "2021-08-15")
        {
        ...
        public async Task<Response<CustomLocationData>> UpdateAsync(string resourceGroupName, string resourceName, Identity identity = null, IDictionary<string, string> tags = null, CustomLocationPropertiesAuthentication authentication = null, IEnumerable<string> clusterExtensionIds = null, string displayName = null, string hostResourceId = null, HostType? hostType = null, string @namespace = null, string provisioningState = null, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateUpdateRequest(resourceGroupName, resourceName, identity, tags, authentication, clusterExtensionIds, displayName, hostResourceId, hostType, @namespace, provisioningState);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/> or <paramref name="resourceName"/> is null. </exception>
        public Response<CustomLocationData> Update(string resourceGroupName, string resourceName, Identity identity = null, IDictionary<string, string> tags = null, CustomLocationPropertiesAuthentication authentication = null, IEnumerable<string> clusterExtensionIds = null, string displayName = null, string hostResourceId = null, HostType? hostType = null, string @namespace = null, string provisioningState = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
