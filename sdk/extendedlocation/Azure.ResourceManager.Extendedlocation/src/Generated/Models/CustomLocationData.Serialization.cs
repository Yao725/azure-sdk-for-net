...
namespace Azure.ResourceManager.Extendedlocation
{
    public partial class CustomLocationData : IUtf8JsonSerializable
    {
        ...
        internal static CustomLocationData DeserializeCustomLocationData(JsonElement element)
        {
            ...
            return new CustomLocationData(id, name, type, tags, location, systemData, authentication.Value, Optional.ToList(clusterExtensionIds), displayName.Value, hostResourceId.Value, Optional.ToNullable(hostType), @namespace.Value, provisioningState.Value);
        }
    }
}
