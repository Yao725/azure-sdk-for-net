...
namespace Azure.ResourceManager.Privatedns
{
    ...
    public partial class VirtualNetworkLinkData : TrackedResource
    {
        ...
        internal VirtualNetworkLinkData(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, Location location, string etag, Models.SubResource virtualNetwork, bool? registrationEnabled, VirtualNetworkLinkState? virtualNetworkLinkState, ProvisioningState? provisioningState) : base(id, name, type, tags, location)
        {
            Etag = etag;
        ...
        public Models.SubResource VirtualNetwork { get; set; }
