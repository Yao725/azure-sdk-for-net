...
namespace Azure.ResourceManager.Privatedns
{
    public partial class VirtualNetworkLinkData : IUtf8JsonSerializable
    {
        ...
        internal static VirtualNetworkLinkData DeserializeVirtualNetworkLinkData(JsonElement element)
        {
            ...
            Optional<Models.SubResource> virtualNetwork = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("virtualNetwork"))
                        {
                            ...
                            virtualNetwork = Models.SubResource.DeserializeSubResource(property0.Value);
                            continue;
                        }
            ...
            return new VirtualNetworkLinkData(id, name, type, tags, location, etag.Value, virtualNetwork.Value, Optional.ToNullable(registrationEnabled), Optional.ToNullable(virtualNetworkLinkState), Optional.ToNullable(provisioningState));
        }
    }
}
