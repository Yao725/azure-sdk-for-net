...
namespace Azure.ResourceManager.Privatedns
{
    ...
    public partial class RecordSetContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly RecordSetsRestOperations _restClient;

        /// <summary> Initializes a new instance of the <see cref="RecordSetContainer"/> class for mocking. </summary>
        protected RecordSetContainer()
        {
        }

        /// <summary> Initializes a new instance of RecordSetContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal RecordSetContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual RecordSetCreateOrUpdateOperation CreateOrUpdate(string relativeRecordSetName, RecordSetData parameters, string ifMatch = null, string ifNoneMatch = null, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("RecordSetContainer.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("RecordSetContainer.Get");
            scope.Start();
            try
            {
                if (relativeRecordSetName == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("RecordSetContainer.GetIfExists");
            scope.Start();
            try
            {
                if (relativeRecordSetName == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("RecordSetContainer.CheckIfExists");
            scope.Start();
            try
            {
                if (relativeRecordSetName == null)
        ...
        public virtual Pageable<RecordSet> GetAll(int? top = null, string recordsetnamesuffix = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("RecordSetContainer.GetAll");
                scope.Start();
                try
                {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("RecordSetContainer.GetAllAsGenericResources");
            scope.Start();
            try
            {
