    ...
    public partial class ArcSetting : ArmResource
    {
        ...
        public async virtual Task<ArcSettingDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ArcSettingDeleteOperation(_clientDiagnostics, Pipeline, _restClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
        ...
        /// <summary> Gets a list of Extensions in the ArcSetting. </summary>
