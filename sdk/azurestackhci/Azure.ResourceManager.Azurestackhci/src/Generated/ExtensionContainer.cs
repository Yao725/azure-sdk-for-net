...
namespace Azure.ResourceManager.Azurestackhci
{
    ...
    public partial class ExtensionContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly ExtensionsRestOperations _restClient;

        /// <summary> Initializes a new instance of the <see cref="ExtensionContainer"/> class for mocking. </summary>
        protected ExtensionContainer()
        {
        }

        /// <summary> Initializes a new instance of ExtensionContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal ExtensionContainer(ArmResource parent) : base(parent)
        {
        ...
        public virtual ExtensionCreateOperation CreateOrUpdate(string extensionName, ExtensionData extension, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("ExtensionContainer.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ExtensionContainer.Get");
            scope.Start();
            try
            {
                if (extensionName == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ExtensionContainer.GetIfExists");
            scope.Start();
            try
            {
                if (extensionName == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ExtensionContainer.CheckIfExists");
            scope.Start();
            try
            {
                if (extensionName == null)
        ...
        public virtual Pageable<Extension> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("ExtensionContainer.GetAll");
                scope.Start();
                try
                {
