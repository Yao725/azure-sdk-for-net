...
namespace Azure.ResourceManager.Azurestackhci.Models
{
    ...
    public partial class ClusterReportedProperties
    {
        ...
        internal ClusterReportedProperties(string clusterName, string clusterId, string clusterVersion, IReadOnlyList<ClusterNode> nodes, DateTimeOffset? lastUpdated)
        {
