...
namespace Azure.ResourceManager.Azurestackhci.Models
{
    ...
    public partial class ClusterNode
    {
        ...
        internal ClusterNode(string name, float? id, string manufacturer, string model, string osName, string osVersion, string serialNumber, float? coreCount, float? memoryInGiB)
        {
            Name = name;
            Id = id;
