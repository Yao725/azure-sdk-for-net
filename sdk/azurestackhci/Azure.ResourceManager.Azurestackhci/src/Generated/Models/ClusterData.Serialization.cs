...
namespace Azure.ResourceManager.Azurestackhci
{
    public partial class ClusterData : IUtf8JsonSerializable
    {
        ...
        internal static ClusterData DeserializeClusterData(JsonElement element)
        {
            ...
            return new ClusterData(id, name, type, tags, location, Optional.ToNullable(provisioningState), Optional.ToNullable(status), cloudId.Value, cloudManagementEndpoint.Value, aadClientId.Value, aadTenantId.Value, reportedProperties.Value, Optional.ToNullable(trialDaysRemaining), billingModel.Value, Optional.ToNullable(registrationTimestamp), Optional.ToNullable(lastSyncTimestamp), Optional.ToNullable(lastBillingTimestamp), createdBy.Value, Optional.ToNullable(createdByType), Optional.ToNullable(createdAt), lastModifiedBy.Value, Optional.ToNullable(lastModifiedByType), Optional.ToNullable(lastModifiedAt));
        }
    }
}
