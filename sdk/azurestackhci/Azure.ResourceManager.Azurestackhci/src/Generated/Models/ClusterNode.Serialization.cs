...
namespace Azure.ResourceManager.Azurestackhci.Models
{
    public partial class ClusterNode
    {
        internal static ClusterNode DeserializeClusterNode(JsonElement element)
        {
            ...
            return new ClusterNode(name.Value, Optional.ToNullable(id), manufacturer.Value, model.Value, osName.Value, osVersion.Value, serialNumber.Value, Optional.ToNullable(coreCount), Optional.ToNullable(memoryInGiB));
        }
    }
}
