...
namespace Azure.ResourceManager.Azurestackhci
{
    internal partial class ExtensionsRestOperations
    {
        ...
        public ExtensionsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, string subscriptionId, Uri endpoint = null, string apiVersion = "2021-09-01")
        {
