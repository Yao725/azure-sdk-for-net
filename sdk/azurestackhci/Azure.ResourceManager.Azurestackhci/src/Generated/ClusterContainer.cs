...
namespace Azure.ResourceManager.Azurestackhci
{
    ...
    public partial class ClusterContainer : ArmContainer
    {
        ...
        public virtual ClusterCreateOperation CreateOrUpdate(string clusterName, ClusterData cluster, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _restClient.Create(Id.ResourceGroupName, clusterName, cluster, cancellationToken);
        ...
        public async virtual Task<ClusterCreateOperation> CreateOrUpdateAsync(string clusterName, ClusterData cluster, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _restClient.CreateAsync(Id.ResourceGroupName, clusterName, cluster, cancellationToken).ConfigureAwait(false);
                var operation = new ClusterCreateOperation(Parent, response);
                if (waitForCompletion)
