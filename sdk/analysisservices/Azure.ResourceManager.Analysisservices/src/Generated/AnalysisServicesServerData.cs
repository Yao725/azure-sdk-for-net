...
namespace Azure.ResourceManager.Analysisservices
{
    ...
    public partial class AnalysisServicesServerData : Resource
    {
        ...
        public AnalysisServicesServerData(Location location, ResourceSku sku) : base(location, sku)
        {
            if (sku == null)
            {
